...
Extract the assignment from the ZIP file.
...
Build the project using IntelliJ build tools.

Running the System
------------------
Option 1 – Using the Launcher (recommended)
Run Launcher.java
To run with multiple drones, set the program argument to the desired count (e.g., 3). Defaults to 1.
Option 2 – Running subsystems manually (in this order)
Run SimulatorGUI.java - wait for the GUI window to appear
Run Scheduler.java - wait for [Scheduler] Listening on port 5000...
Run DroneSubsystem.java - wait for [Drone 1] Listening on port 6001...
Run FireIncidentSubsystem.java - run last, it sends events immediately
...
--------------------
Open the test directory under Deliverables/I2/src/main/tests/ in IntelliJ.
